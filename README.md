# fnp_sales_analysis
It contains dashboard  presenting sales analysis of fnp during festival seasons
```


Challenge
From the given a dataset from FNP (Ferns and Petals) that specializes in sending gifts
